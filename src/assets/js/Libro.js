...
for (var i = 0; i < uno.length; i++) {
	...
	uno[i].addEventListener('click', function(e){
		...
		if (tgt.getAttribute('class') == 'portada' || tgt.getAttribute('id') == 'portada' ||tgt.getAttribute('class') == 'next') {
			unoThis.style.zIndex = contZindex;
			contZindex +=20;
			setTimeout(function(){
		...
		if (tgt.getAttribute('class') == 'portada-back' || tgt.getAttribute("class") == 'back') {
			unoThis.style.zIndex = contZindex;
			contZindex +=20;
		...
		if (tgt.getAttribute('class') == 'portada' || tgt.getAttribute('id') == 'portada') {
